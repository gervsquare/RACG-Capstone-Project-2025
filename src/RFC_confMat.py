...
def RFClassifier_confusion_matrix(X_train, X_test, y_train, y_test):
    # For classification
    ...
    print(f"\nModel Accuracy with RandomForestClassifier's selected features: {accuracy} or {accuracy * 100:.2f}%")
    print()
    ...
    plt.title(f"Confusion Matrix for RFClassifier Model")
    plt.show()
